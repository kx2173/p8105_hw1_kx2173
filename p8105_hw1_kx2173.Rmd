...
Now, I see what the data looks like `r view(penguins)`, including names of variables: `r names(penguins)`. 
The first 6 values of variable in data set: `r head(penguins)`
The last 6 values of variable in data set: `r tail(penguins)`
